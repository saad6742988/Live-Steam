...
public class AgoraReceiver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agora_receiver);
    ...
    private void setupRemoteVideo() {
        ...
        mRtcEngine.setupRemoteVideo(new VideoCanvas(localSurfaceView, VideoCanvas.RENDER_MODE_HIDDEN, 0));
    }
    ...
    private void onRemoteUserJoined(int uid, int elapsed) {
        // no need to add the remote video view as the app only receives the video broadcast
    }
